...
from tink_fpe.proto.fpe_ffx_pb2 import FpeFfxKey, FpeFfxKeyFormat
...
class FpeFfxKeyManager(tink.core.KeyManager[FpeFfxKey]): #type: ignore
    ...
    def primitive(self, key_data: tink_pb2.KeyData) -> _fpe.Fpe:
        ...
        return _fpe_ff3.FpeFf3(key=fpe_ffx_key.key_value,
                               alphabet=fpe_ffx_key.params.alphabet)
    ...
    def new_key_data(self, key_template: tink_pb2.KeyTemplate) -> tink_pb2.KeyData:
        ...
        ffx_key.key_value = random.randbytes(n=int(ffx_key_format.key_size / 8))
        ffx_key.version = 0
